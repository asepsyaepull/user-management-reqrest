...
const ProfileCard = ({ user, onClick }) => {
    ...
    return (
        <div className="flex container mx-auto justify-between p-4 bg-white dark:bg-gray-800 shadow rounded-lg hover:shadow-lg hover:bg-olive-50/30 transition duration-300 cursor-pointer" onClick={onClick}>
            <div className="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <div className="flex gap-20 text-gray-500 dark:text-gray-400">
